...
import { getFirestore, connectFirestoreEmulator, collection, getDocs, GeoPoint } from 'firebase/firestore';
...
const FirebaseProvider = (props) => {
  ...
  // useEffect(() => {
  //   const geoFirestore = new GeoFirestore(myFS); // Use Firestore instance

  //   const performGeoQuery = () => {
  //     const geoCollection = geoFirestore.collection('locations');
  //     const query = geoCollection.near({
  //       center: new GeoPoint(53.54992, 10.00678), // Use GeoPoint class
  //       radius: 10
  //     });
  ...
  const theValues = {
    ...
    usingEmulators,
    GeoPoint,
    // fetchCommunities, // Add fetchCommunities to the context values
    //fetchBooks,
  };
 ...
 * @property {import('firebase/firestore').GeoPoint} GeoPoint - Firestore GeoPoint class
* @property {() => Promise<any[]>} fetchCommunities - function to fetch communities collection 
* 
