...
const FrameComponent1 = memo(({ className = "" }) => {
  return (
    ...
    >
      <footer className="flex-1 flex flex-col items-start justify-start gap-[0.6px] max-w-full text-left text-smi text-gray-100 font-text">
        ...
        <div className="w-[562.5px] flex flex-row items-start justify-start py-0 px-1.5 box-border max-w-full text-base text-white">
          <div className="flex-1 relative leading-[18px] inline-block max-w-full z-[1]">
            ...
            <p className="m-0 whitespace-pre-wrap">{`#snow_slip #private  `}</p>
          </div>
        </div>
      </footer>
    </section>
