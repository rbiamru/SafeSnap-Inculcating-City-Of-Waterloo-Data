...
const PublicPost = () => {
  ...
  return (
    <div className="w-full relative bg-darkslategray-200 overflow-hidden flex flex-row items-start justify-start leading-[normal] tracking-[normal]">
      <main className="flex-1 [backdrop-filter:blur(8px)] [background:linear-gradient(180deg,_rgba(56,_55,_58,_0.7),_#38373a)] flex flex-col items-end justify-start pt-[50px] pb-[65.5px] pr-[18px] pl-2 box-border gap-[17.5px] max-w-full mq720:pt-8 mq720:pb-[43px] mq720:box-border">
